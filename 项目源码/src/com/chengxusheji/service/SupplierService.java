...
public class SupplierService {
    ...
    /*按照查询条件分页查询供应商记录*/
    public ArrayList<Supplier> querySupplier(String supplierName,String city,String aPerson,String djrlxfs,String luruTime,String luruRen,int currentPage) throws Exception { 
     	String where = "where 1=1";
    	if(!supplierName.equals("")) where = where + " and t_supplier.supplierName like '%" + supplierName + "%'";
    	if(!city.equals("")) where = where + " and t_supplier.city like '%" + city + "%'";
    	if(!aPerson.equals("")) where = where + " and t_supplier.aPerson like '%" + aPerson + "%'";
    	if(!djrlxfs.equals("")) where = where + " and t_supplier.djrlxfs like '%" + djrlxfs + "%'";
    	if(!luruTime.equals("")) where = where + " and t_supplier.luruTime like '%" + luruTime + "%'";
    	if(!luruRen.equals("")) where = where + " and t_supplier.luruRen like '%" + luruRen + "%'";
    	int startIndex = (currentPage-1) * this.rows;
    	return supplierMapper.querySupplier(where, startIndex, this.rows);
    }

    /*按照查询条件查询所有记录*/
    public ArrayList<Supplier> querySupplier(String supplierName,String city,String aPerson,String djrlxfs,String luruTime,String luruRen) throws Exception  { 
     	String where = "where 1=1";
    	if(!supplierName.equals("")) where = where + " and t_supplier.supplierName like '%" + supplierName + "%'";
    	if(!city.equals("")) where = where + " and t_supplier.city like '%" + city + "%'";
    	if(!aPerson.equals("")) where = where + " and t_supplier.aPerson like '%" + aPerson + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String supplierName,String city,String aPerson,String djrlxfs,String luruTime,String luruRen) throws Exception {
     	String where = "where 1=1";
    	if(!supplierName.equals("")) where = where + " and t_supplier.supplierName like '%" + supplierName + "%'";
    	if(!city.equals("")) where = where + " and t_supplier.city like '%" + city + "%'";
    	if(!aPerson.equals("")) where = where + " and t_supplier.aPerson like '%" + aPerson + "%'";
