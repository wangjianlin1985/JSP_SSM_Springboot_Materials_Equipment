...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">物资设备网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                <li><a href="<%=basePath %>index.jsp">首页</a></li>
                 <li><a href="<%=basePath %>Company/frontlist">公司物需点</a></li>
                <!-- <li><a href="<%=basePath %>Employee/frontlist">职工</a></li> 
                <li><a href="<%=basePath %>XzAdmin/frontlist">行政管理</a></li>
                -->
                <li><a href="<%=basePath %>Supplier/frontlist">供应商列表</a></li>
                <li><a href="<%=basePath %>Department/frontlist">部门查询</a></li>
                <li><a href="<%=basePath %>Product/frontlist">物资查询</a></li>
                <li><a href="<%=basePath %>Purchase/frontlist">物资采购</a></li>
                <li><a href="<%=basePath %>Apply/frontlist">物资申领</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>Apply/apply_frontEmpAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;物资申领</a></li>
                        <li><a href="<%=basePath %>Apply/empFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我申领的物资</a></li>
