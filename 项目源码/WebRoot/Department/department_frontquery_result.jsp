...
<jsp:include page="../header.jsp"></jsp:include>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>部门id</td><td>部门名称</td><td>部门职责</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
 										...
 										<tr>
 											...
 											<td><%=department.getDepartmentDesc() %></td>
 											<td>
	...
	<div style="display:none;">
		...
		<form name="departmentQueryForm" id="departmentQueryForm" action="<%=basePath %>Department/frontlist" class="mar_t15">
